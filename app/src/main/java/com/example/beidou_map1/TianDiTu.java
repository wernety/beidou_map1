...
public class TianDiTu {
    ...
    private static final String URL_VECTOR_2000 = "http://{subDomain}.tianditu.com/DataServer?T=vec_c&x={1}&y={1}&l={5}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_VECTOR_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=cva_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_VECTOR_ANNOTATION_ENGLISH_2000 = "http://{subDomain}.tianditu.com/DataServer?T=eva_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_IMAGE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=img_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_IMAGE_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=cia_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_IMAGE_ANNOTATION_ENGLISH_2000 = "http://{subDomain}.tianditu.com/DataServer?T=eia_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_TERRAIN_2000 = "http://{subDomain}.tianditu.com/DataServer?T=ter_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_TERRAIN_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=cta_c&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    //
    public static final String URL_VECTOR_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=vec_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_VECTOR_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=cva_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_VECTOR_ANNOTATION_ENGLISH_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=eva_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_IMAGE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=img_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_IMAGE_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=cia_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_IMAGE_ANNOTATION_ENGLISH_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=eia_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_TERRAIN_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=ter_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    private static final String URL_TERRAIN_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=cta_w&x={col}&y={row}&l={level}&tk=f786d9d174cfdb0011c5de6213e762aa";
    ...
    private static final double X_MIN_2000 = 72;
    private static final double Y_MIN_2000 = 3;
    private static final double X_MAX_2000 = 136;
    private static final double Y_MAX_2000 = 54;
...
/*
    下面这些是坐标系转换，CSDN博客上有描述,准确说是比例尺和实际位置的像素转换
    比如，1：2.9 = 78271 / 手机的像素点（79dp) * k k是个常数
*/
...
//                    添加切片的比例尺，这个比例尺是怎么计算的？
            ...
            /*
                dpi- 每个磁贴的 DPI
                imageFormat- 磁贴图像的格式
                levelOfDetails- 级别详细信息实例列表，每个详细级别一个
                origin- 原点
                spatialReference- 瓷砖的空间参考
                tileHeight- 图块的高度，以像素为单位
                tileWidth- 磁贴的宽度，以像素为单位
            */
            ...
            webTiledLayer = new WebTiledLayer(
                    ...
                    mainTileInfo,
                    mainEnvelope);
//            第一个是网址，第二个就是subdomain，第三个就是其他的信息，比如 列，行等，最后一个是坐标系
